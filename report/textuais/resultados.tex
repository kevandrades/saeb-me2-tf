...
A \autoref{tab:esc_mae_notas} apresenta as comparações par a par de diferenças de notas entre os alunos
para cada escolaridade da mãe.
\begin{table}[htb]
    \centering
...
As hipóteses iniciais para variável Escolaridade da Mãe são passadas na coluna Comparações,

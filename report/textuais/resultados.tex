...
\chapter{Comparações}
Para avaliar os fatores, foi explorado o tempo diário gasto em afazeres domésticos
em relação às notas.
...
O gráfico a seguir mostra como se distribuem esses tempos em relação ao sexo.
...
domésticas. Pelo menos 60\% destes o representam, em cada tempo,
de no mínimo uma hora, o que pode indicar que estudantes de sexo masculino
têm mais disponibilidade de tempo para estudo.

...
Estudantes do sexo feminino tendem a gastar mais tempo com atividades
...
que mostra o tempo gasto pelos alunos com atividades domésticas pra cada escolaridade da mãe.
...
%%%%%%%%%%%%%%%%%%%%%%% Tabelas %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
O teste de Bartlett para igualdade de variâncias foi aplicado para os tempos gastos por raça/cor,
escolaridade da mãe e sexo. Os resultados são apresentados na \autoref{tab:af_test}.

Ao realizar testes estatísticos com base nesses afazeres, na \autoref{tab:af_test}, e com a
...
raça/cor dos alunos, foram obtidas evidências significativas, apontando que não há indícios 
de diferenças, na média, entre as raças/cores, no tempo gasto nestes afazeres.
\clearpage
%%%%% Tabela dos testes paras relações com afazeres domesticos

\begin{table}[htb]
    \caption{Testes de igualdade das variabilidades sobre as relações 
...
Ao testar a variável raça/cor dos alunos, não foram obtidas evidências significativas,
...
com base na escolaridade das mães dos alunos\label{tab:esc_mae_afzr}}
    ...
    \nota[Anotações]{Aprox. 0 refere-se à algum número muito pequeno considerando aproximadamente zero,
                    e EF e EM remete ao ensino fundamental e ensino médio respectivamente.}
\end{table}

O teste realizado com base na escolaridade da mãe sobre o tempo em afazeres domésticos obteve evidências significativas sobre existência de diferença
...
Na \autoref{img:loc_notas}, é possível observar um grau de assimetria um pouco maior nas notas para a região rural
...
das mães é maior, de modo que os alunos cujas as mães têm grau de escolaridade alto têm tendência
a obterem melhor desempenho em provas. Esse comportamento é observado mesmo entre os outliers,
...
Ao realizar testes, verificou se em média, esta soma de notas, hávia indícios de aceitar
alguma diferença significativa com base em alguma relação abordada com a confiança 95\%.
Para efetuar estes testes, foi avaliado primeiramente a hipótese de igualdade sobre as variâncias
das notas (Teste B) para cada relação efetuada pelo estudo como as localizações das escolas, 
escolaridade da mãe, sexo e a raça/cor do aluno, no qual apenas a relação com o sexo rejeita esta hipótese.

Ao concluir sobre as relações com as variâncias, \autoref{tab::tests_notas}, foi avaliado estas
hipóteses de igualdades dessas médias, que pelo mesmo nível de confiança, houve indícios de rejeita 
com base nos sexos, que diz sobre não existir a diferença sobre as médias entre estas notas com base no 
sexo do aluno. Sobe a mesma hipótese, as relações com a raça/cor do aluno e a escolaridade da mãe (Teste ANOVA), 
houve indícios significativos de que em alguma destas relações houve alguma diferença com base na média,
no qual testes dois a dois (Teste T) são apropriados para investigar qual foi estas diferenças.
Para a relação com as localizações das escolas, também foi rejeitada essa hipótese, no qual as escolas 
urbanas obteve a média desta soma de notas dos alunos superior às escolas rurais.
...
A raça branca apresentou diferença nos testes de igualdade de média, dois a dois, entre todas as outras
raças, confirmando o que a \autoref{fig:raca_cor_notas} apontava. Há uma clara desigualdade entre as notas por raça
quando se compara a branca com as demais, e quase todas as desigualdades derivaram dela por possui maiores notas que os
demais.

As únicas desigualdades que não foram entre comparações de indivíduos de cor branca com outros,
foram a comparação entre os indivíduos pardos e pretos, e também a comparação entre os indivíduos pardos 
...
significativamente alto, que diz respeito ao nível de confiabilidade elevados.
...
no que supõe igualdade entre as médias das somas dessas notas com cada grupo com base nestes níveis.

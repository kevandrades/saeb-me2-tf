...
O tempo gasto com afazeres domésticos pode privar o aluno de exercer o conhecimento
...
\newpage
Ao comparar os períodos de tempo nestes afazeres com o nível escolaridade da mãe,
\autoref{esc_mae_afazeres}, a proporção de alunos que exercem estas atividades, para
cada nível escolar da  mãe, há pelo menos 70\% localizado entre os que 
...
confiança de 95\%, a variável sexo obteve evidências substâncias para afirmar que o tempo
em média realizado não é proporcional à ambos os sexos, no qual o sexo feminino possui
proporções superiores em períodos de tempo maiores nestas atividades. Ao testar a variável
raça/cor dos alunos, não obteve mesma evidência, o que diz sobre não ter indícios 
...
ao mesmo nível de confiança, obteve evidências substanciais sobre alguma diferença existir
...
o que grande parte destes gastam menos de uma hora. O mesmo se observa para as mães com o nível
escolar de 5\textsuperscript{o} incompleto, no qual o que apenas não se difere é dos alunos que
responderam que não sabia deste nível sobre a mãe. As mães que completou o 9\textsuperscript{o}
obteve igualdade apenas com as mães do 5\textsuperscript{o} e aqueles que respoderam que não
sabia. Para aquelas mães que completou a faculdade, há igualdade entre as que completaram o
ensino médio, no qual o tempo de afazeres por parte dos alunos para as mães com o nível de 
escolaridade do 5\textsuperscript{o} ou superior, possui maiores proporções entre 1 e 2 horas,
...
A Figura \ref{img:loc_notas} mostra as distribuições das somas das notas por localização.
\begin{figure}[htb]
    \label{img:loc_notas}
